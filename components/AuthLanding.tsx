...
export const AuthLanding = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-[#FDFBF7] p-4 font-sans">
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-stone-200/50 overflow-hidden border border-stone-100">
                ...
                <div className="flex border-b border-stone-100 bg-stone-50/50">
                    <button
                        ...
                        className={`flex-1 py-4 text-sm font-medium transition-colors border-b-2 ${activeTab === 'login'
                    ...
                    <button
                        ...
                        className={`flex-1 py-4 text-sm font-medium transition-colors border-b-2 ${activeTab === 'register'
                                ? 'border-stone-900 text-stone-900 bg-white'
                                : 'border-transparent text-stone-400 hover:text-stone-600'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex-1 py-4 text-sm font-medium transition-colors border-b-2 ${activeTab === 'staff'
                                ? 'border-stone-900 text-stone-900 bg-white'
                                : 'border-transparent text-stone-400 hover:text-stone-600'
                            }`}
                    >
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full flex justify-center items-center gap-2 py-3.5 px-6 text-white rounded-xl font-medium text-lg focus:outline-none focus:ring-4 disabled:opacity-70 disabled:cursor-wait transition-all shadow-lg transform active:scale-[0.98] ${activeTab === 'staff'
            ...
            <div className="max-w-md w-full mt-10 mb-6">
                <h3 className="text-stone-400 font-bold text-xs uppercase tracking-widest text-center mb-6">How It Works</h3>
                <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="flex flex-col items-center">
                        ...
                        <h4 className="font-serif text-stone-900 font-medium text-sm mb-1">1. Sign Up</h4>
                        <p className="text-xs text-stone-500 leading-relaxed">Create a quick account to get started.</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center text-stone-600 mb-2">
                            <LogIn className="w-5 h-5" />
                        </div>
                        <h4 className="font-serif text-stone-900 font-medium text-sm mb-1">2. Request</h4>
                        <p className="text-xs text-stone-500 leading-relaxed">Select items and enter custom text.</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center text-stone-600 mb-2">
                            <ShieldCheck className="w-5 h-5" />
                        </div>
                        <h4 className="font-serif text-stone-900 font-medium text-sm mb-1">3. Track</h4>
                        <p className="text-xs text-stone-500 leading-relaxed">Watch the queue and pick up when done.</p>
                    </div>
                </div>
            </div>

            <div className="text-xs text-stone-400 font-serif italic text-center mt-4">
